...
1. S165  init's Detect table covers a moltke AGENTS.md without adocs/
2. S166  init records adoption under the next free DEC id
3. S167  MANUAL and the ruleset agree on the merge-collision renumber
4. S168  the audit id grammar can express its own re-run suffix
5. S169  MANUAL discloses that an install ships this repository whole
6. S170  README's Ship order commits the bump before the push
