...
1. S168  the audit id grammar can express its own re-run suffix
2. S169  MANUAL discloses that an install ships this repository whole
3. S170  README's Ship order commits the bump before the push
